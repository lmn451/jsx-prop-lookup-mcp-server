...
describe('MCP Server Integration', () => {
  ...
  test('should initialize MCP server', async () => {
    ...
    try {
      ...
      assert.strictEqual(response.result.serverInfo.name, 'jsx-prop-lookup-server', 'Server name should match');
    } finally {
      client.close();
    }
  });
  ...
  test('should list available tools', async () => {
    ...
    try {
      ...
      assert.ok(toolNames.includes('find_components_without_prop'), 'Should have find_components_without_prop tool');
    } finally {
      client.close();
    }
  });
  ...
  test('should call find_components_without_prop tool', async () => {
    ...
    try {
      ...
      assert.ok(typeof result.summary.missingPropCount === 'number', 'Should have missingPropCount');
